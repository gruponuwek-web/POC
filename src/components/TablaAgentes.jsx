...
export default function TablaAgentes({ agentes, onSelectAgente, agenteSeleccionado, filtros }) {
  ...
  const exportCSV = () => {
    const cols = ['agente','ventas','meta','diferencia_meta','cumplimiento_pct','cartera_total','clientes_atendidos','cobertura_pct','clientes_nuevos','clientes_recuperados','tickets','ticket_promedio','costo','margen','margen_pct']
            ...
            {filtered.map((a, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={{ ...tdStyle, fontWeight:700 }}>{fmt.pct(a.margen_pct)}</td>
                </tr>
              )
            })}
          </tbody>
